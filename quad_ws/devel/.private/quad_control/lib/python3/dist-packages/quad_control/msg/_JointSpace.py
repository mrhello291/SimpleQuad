...
"""autogenerated by genpy from quad_control/JointSpace.msg. Do not edit."""
import codecs
import sys
...
float32 theta3"""
  ...
  _slot_types = ['std_msgs/Header','uint32','time','string','quad_control/Angle','quad_control/Angle','quad_control/Angle','quad_control/Angle']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.FL_foot is None:
        self.FL_foot = quad_control.msg.Angle()
      if self.FR_foot is None:
        self.FR_foot = quad_control.msg.Angle()
      if self.RL_foot is None:
        self.RL_foot = quad_control.msg.Angle()
      if self.RR_foot is None:
        self.RR_foot = quad_control.msg.Angle()
    else:
      self.header = std_msgs.msg.Header()
      self.seq = 0
      self.stamp = genpy.Time()
