...
class JointSpace {
  ...
  static datatype() {
    ...
    return 'quad_control/JointSpace';
  }
  ...
  static messageDefinition() {
    ...
    std_msgs/Header header
      ...
      time stamp
      string frame_id
    quad_control/Angle FL_foot
    quad_control/Angle FR_foot
    quad_control/Angle RL_foot
    quad_control/Angle RR_foot
    ================================================================================
    MSG: std_msgs/Header
