...
(cl:defmethod cl:initialize-instance :after ((m <TaskSpace>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskSpace)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_control-msg:<TaskSpace> is deprecated: use quad_control-msg:TaskSpace instead.")))
