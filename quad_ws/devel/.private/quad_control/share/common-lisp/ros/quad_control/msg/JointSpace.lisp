...
(cl:defclass <JointSpace> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (FL_foot
    :reader FL_foot
    :initarg :FL_foot
    :type quad_control-msg:Angle
    :initform (cl:make-instance 'quad_control-msg:Angle))
   (FR_foot
    :reader FR_foot
    :initarg :FR_foot
    :type quad_control-msg:Angle
...
(cl:defmethod cl:initialize-instance :after ((m <JointSpace>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointSpace)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_control-msg:<JointSpace> is deprecated: use quad_control-msg:JointSpace instead.")))
...
(cl:defmethod seq-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:seq-val is deprecated.  Use quad_control-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:stamp-val is deprecated.  Use quad_control-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:frame_id-val is deprecated.  Use quad_control-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'FL_foot-val :lambda-list '(m))
(cl:defmethod FL_foot-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:FL_foot-val is deprecated.  Use quad_control-msg:FL_foot instead.")
  (FL_foot m))

(cl:ensure-generic-function 'FR_foot-val :lambda-list '(m))
(cl:defmethod FR_foot-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:FR_foot-val is deprecated.  Use quad_control-msg:FR_foot instead.")
  (FR_foot m))

(cl:ensure-generic-function 'RL_foot-val :lambda-list '(m))
(cl:defmethod RL_foot-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:RL_foot-val is deprecated.  Use quad_control-msg:RL_foot instead.")
  (RL_foot m))

(cl:ensure-generic-function 'RR_foot-val :lambda-list '(m))
(cl:defmethod RR_foot-val ((m <JointSpace>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_control-msg:RR_foot-val is deprecated.  Use quad_control-msg:RR_foot instead.")
  (RR_foot m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointSpace>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%  uint32 seq~%  time stamp~%  string frame_id~%quad_control/Angle FL_foot~%quad_control/Angle FR_foot~%quad_control/Angle RL_foot~%quad_control/Angle RR_foot~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: quad_control/Angle~%float32 theta1~%float32 theta2~%float32 theta3~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointSpace)))
  "Returns full string definition for message of type 'JointSpace"
  (cl:format cl:nil "std_msgs/Header header~%  uint32 seq~%  time stamp~%  string frame_id~%quad_control/Angle FL_foot~%quad_control/Angle FR_foot~%quad_control/Angle RL_foot~%quad_control/Angle RR_foot~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: quad_control/Angle~%float32 theta1~%float32 theta2~%float32 theta3~%~%"))
