...
rospack.get_path('quad_peripheral_interfacing') + "/lib/emptybatterystatus_white.png"

class DingoDisplayNode:
    def __init__(self):
        rospy.init_node('quad_display_node')
    ...
    def run(self):
        try:
            ...
            batt_status = Image.open(rospack.get_path('quad_peripheral_interfacing') + "/lib/emptybatterystatus_white.png")
