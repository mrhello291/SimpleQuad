...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/mrhello/SimpleQuad/quad_ws/install/lib/python3/dist-packages:/home/mrhello/SimpleQuad/quad_ws/build/quad_input_interfacing/lib/python3/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/mrhello/SimpleQuad/quad_ws/build/quad_input_interfacing" \
    "/usr/bin/python3" \
    "/home/mrhello/SimpleQuad/quad_ws/src/quad_hardware_interfacing/quad_input_interfacing/setup.py" \
     \
    build --build-base "/home/mrhello/SimpleQuad/quad_ws/build/quad_input_interfacing" \
    install \
    --root="${DESTDIR-/}" \
